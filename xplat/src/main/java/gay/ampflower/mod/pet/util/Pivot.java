...
public interface Pivot {
	...
	static <A> void registerCollars(BiConsumer<Item, A> collarConsumer, A cosmetic, A armor, A gimick) {
		...
		collarConsumer.accept(PROGRESS_COLLAR, cosmetic);
		...
		collarConsumer.accept(NONBINARY_COLLAR, cosmetic);
		collarConsumer.accept(ARO_COLLAR, cosmetic);
		collarConsumer.accept(DEMIROMANTIC_COLLAR, cosmetic);
		collarConsumer.accept(ACE_COLLAR, cosmetic);
		collarConsumer.accept(DEMISEXUAL_COLLAR, cosmetic);
		collarConsumer.accept(AROACE_COLLAR, cosmetic);
		collarConsumer.accept(APLATONIC_COLLAR, cosmetic);
		collarConsumer.accept(GREYROSE_COLLAR, cosmetic);
		collarConsumer.accept(GREYACE_COLLAR, cosmetic);
		collarConsumer.accept(GREYARO_COLLAR, cosmetic);
		collarConsumer.accept(LESBIAN_COLLAR, cosmetic);
		collarConsumer.accept(GAY_COLLAR, cosmetic);
		collarConsumer.accept(BISEXUAL_COLLAR, cosmetic);
		collarConsumer.accept(PAN_COLLAR, cosmetic);
		collarConsumer.accept(POLYAMORY_COLLAR, cosmetic);
	...
	static void registerCollars(Consumer<ItemConvertible> collarConsumer) {
		...
		collarConsumer.accept(PROGRESS_COLLAR);
		...
		collarConsumer.accept(NONBINARY_COLLAR);
		collarConsumer.accept(ARO_COLLAR);
		collarConsumer.accept(DEMIROMANTIC_COLLAR);
		collarConsumer.accept(ACE_COLLAR);
		collarConsumer.accept(DEMISEXUAL_COLLAR);
		collarConsumer.accept(AROACE_COLLAR);
		collarConsumer.accept(APLATONIC_COLLAR);
		collarConsumer.accept(GREYROSE_COLLAR);
		collarConsumer.accept(GREYACE_COLLAR);
		collarConsumer.accept(GREYARO_COLLAR);
		collarConsumer.accept(LESBIAN_COLLAR);
		collarConsumer.accept(GAY_COLLAR);
		collarConsumer.accept(BISEXUAL_COLLAR);
		collarConsumer.accept(PAN_COLLAR);
		collarConsumer.accept(POLYAMORY_COLLAR);
