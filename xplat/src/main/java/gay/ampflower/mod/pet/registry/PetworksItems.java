...
public final class PetworksItems {
	public static final Item
		...
		PROGRESS_COLLAR = registerCollar("progress_collar", CollarMaterials.CLOTH,
			PetworksBlocks.PROGRESS_COLLAR, PetworksBlocks.PROGRESS_COLLAR_WALL),
		...
		NONBINARY_COLLAR = registerCollar("nonbinary_collar", CollarMaterials.CLOTH,
			PetworksBlocks.NONBINARY_COLLAR, PetworksBlocks.NONBINARY_COLLAR_WALL),
		ARO_COLLAR = registerCollar("aro_collar", CollarMaterials.CLOTH,
			PetworksBlocks.ARO_COLLAR, PetworksBlocks.ARO_COLLAR_WALL),
		DEMIROMANTIC_COLLAR = registerCollar("demiromantic_collar", CollarMaterials.CLOTH,
			PetworksBlocks.DEMIROMANTIC_COLLAR, PetworksBlocks.DEMIROMANTIC_COLLAR_WALL),
		ACE_COLLAR = registerCollar("ace_collar", CollarMaterials.CLOTH,
			PetworksBlocks.ACE_COLLAR, PetworksBlocks.ACE_COLLAR_WALL),
		DEMISEXUAL_COLLAR = registerCollar("demisexual_collar", CollarMaterials.CLOTH,
			PetworksBlocks.DEMISEXUAL_COLLAR, PetworksBlocks.DEMISEXUAL_COLLAR_WALL),
		...
		GREYROSE_COLLAR = registerCollar("greyrose_collar", CollarMaterials.CLOTH,
			PetworksBlocks.GREYROSE_COLLAR, PetworksBlocks.GREYROSE_COLLAR_WALL),
		GREYACE_COLLAR = registerCollar("greyace_collar", CollarMaterials.CLOTH,
			PetworksBlocks.GREYACE_COLLAR, PetworksBlocks.GREYACE_COLLAR_WALL),
		GREYARO_COLLAR = registerCollar("greyaro_collar", CollarMaterials.CLOTH,
			PetworksBlocks.GREYARO_COLLAR, PetworksBlocks.GREYARO_COLLAR_WALL),
		...
		BISEXUAL_COLLAR = registerCollar("bisexual_collar", CollarMaterials.CLOTH,
			PetworksBlocks.BISEXUAL_COLLAR, PetworksBlocks.BISEXUAL_COLLAR_WALL),
		PAN_COLLAR = registerCollar("pan_collar", CollarMaterials.CLOTH,
			PetworksBlocks.PAN_COLLAR, PetworksBlocks.PAN_COLLAR_WALL),
		POLYAMORY_COLLAR = registerCollar("polyamory_collar", CollarMaterials.CLOTH,
			PetworksBlocks.POLYAMORY_COLLAR, PetworksBlocks.POLYAMORY_COLLAR_WALL),
