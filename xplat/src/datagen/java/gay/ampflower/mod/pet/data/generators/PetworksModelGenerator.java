...
public class PetworksModelGenerator extends FabricModelProvider {
	...
	public void generateItemModels(final ItemModelGenerator itemModelGenerator) {
		...
		collarItem(itemModelGenerator, PetworksItems.WORLDWIDEPIXEL_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.MISSING_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.PRIDE_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.PROGRESS_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.TRANS_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.GENDERQUEER_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.GENDERFLUID_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.AGENDER_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.BIGENDER_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.DEMIBOY_1_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.DEMIBOY_2_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.DEMIGENDER_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.DEMIGIRL_1_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.DEMIGIRL_2_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.INTERSEX_1_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.INTERSEX_2_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.NONBINARY_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.ARO_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.DEMIROMANTIC_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.ACE_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.DEMISEXUAL_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.AROACE_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.APLATONIC_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.GREYROSE_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.GREYACE_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.GREYARO_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.LESBIAN_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.GAY_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.BISEXUAL_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.PAN_COLLAR, false);
		collarItem(itemModelGenerator, PetworksItems.POLYAMORY_COLLAR, false);
